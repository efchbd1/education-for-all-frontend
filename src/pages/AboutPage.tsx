...
import { Container, Typography, Card, CardContent, Grid, Button } from '@material-ui/core';
  ...
  return (
    <Container className={classes.container}>
      ...
      <Card className={classes.card}>
        <CardContent>
          <ul>
            <li className={classes.listItem}><strong>מענה זמין ובחינם:</strong> המענה שניתן להורים זמין לאורך כל הזמן וללא עלות, כך שכל הורה יכול לקבל תשובות לשאלותיו בצורה נוחה ונגישה.</li>
